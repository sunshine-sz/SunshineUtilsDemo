...
public class YoutubeLayout extends ViewGroup {
    ...
    public YoutubeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        viewDragHelper = ViewDragHelper.create(this, 1f, new ViewDragHelperBack());
    }
    ...
    boolean smoothSlideTo(float slideOffset) {
        ...
        if (viewDragHelper.smoothSlideViewTo(mHeaderView, mHeaderView.getLeft(), y)) {
    ...
    private class ViewDragHelperBack extends ViewDragHelper.Callback {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                mInitialMotionX = x;
                mInitialMotionY = y;
                interceptTap = viewDragHelper.isViewUnder(mHeaderView, (int) x, (int) y);
                break;
            }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        boolean isHeaderViewUnder = viewDragHelper.isViewUnder(mHeaderView, (int) x, (int) y);
